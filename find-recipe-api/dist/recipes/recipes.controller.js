...
let RecipesController = class RecipesController {
    ...
    getRandomRecipe(i, q) {
        return this.recipesService.getRecipePuppyData(`http://www.recipepuppy.com/api/?i=${i}&q=${q}`).pipe(recipes_util_1.findRandomRecipe(), recipes_util_1.makeRandomFullRecipe(), operators_1.flatMap((recipe) => {
            ...
            return this.recipesService.getDownstreamFoodsResponseData('https://trackapi.nutritionix.com/v2/natural/nutrients', payload, headers).pipe(recipes_util_1.reduceDownstreamNutritionResponse(recipe));
        }));
    }
};
__decorate([
